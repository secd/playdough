...
//  Teaset
//
//  Created by Kahp Term on 2017/03/29.
//  Copyright © 2017 Bezier Dynamics. All rights reserved.
//
/*
#include <iostream>
...
int main(int argc, char * argv[])
{
    ...
    while(1){
        ...
        read(new_conn_fd, buffbuff, 4);
        //status = read(new_conn_fd, buffbuff, 4, 0);
        
        
        //status = send(new_conn_fd,"Welcome", 7,0);
        status = send(new_conn_fd,buffbuff, 4,0);
